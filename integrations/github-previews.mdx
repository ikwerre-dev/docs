...
description: "Set up automatic deployments on push and ephemeral pull request preview environments with Pxxl's GitHub integration."
---
...
<Tip>
  To test the preview pipeline without affecting your team's review queue, open a **draft pull request**. Pxxl still provisions a full preview environment for draft PRs, so you can validate the build and URL mapping before marking the PR as ready for review.
</Tip>

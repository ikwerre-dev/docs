---
title: "Authenticate Pxxl API Requests with Bearer Tokens"
sidebarTitle: "Authentication"
description: "Pass your Pxxl API key as a Bearer token in the Authorization header to authenticate every platform API request."
---

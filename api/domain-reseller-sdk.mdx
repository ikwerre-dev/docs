...
description: "Search domains, fetch TLD pricing, inspect promo prices, and respect Pxxl domain API rate limits."
---

The `pxxl` package includes domain reseller methods for availability and pricing.

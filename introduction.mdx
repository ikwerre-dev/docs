---
title: "Pxxl: Cloud Deployment Platform for Developers"
sidebarTitle: "Introduction"
description: "Learn what Pxxl is, who it's for, and how it turns a GitHub repository into a live, production-ready URL in seconds."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Databases" icon="database">
    Provision managed PostgreSQL and other database services directly from the Pxxl dashboard — no external provider needed.
  </Card>

---
title: "Framework Deployment Recipes for Pxxl"
sidebarTitle: "Framework Recipes"
description: "Copy-paste build configurations for React, Next.js, Nuxt, Express, FastAPI, Django, Laravel, Go, Ruby, .NET, Rust, and more."
---
